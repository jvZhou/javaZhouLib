...
(function(h, n) {
        ...
        function l(c) {
            var a, b, d, e = {};
            void 0 === c ? (d = window.location,
                c = d.host,
                a = d.pathname,
                b = d.search.substr(1),
                d = d.hash) : (d = c.match(/\w+:\/\/((?:[\w-]+\.)+\w+)(?:\:\d+)?(\/[^\?\\\"\'\|\:<>]*)?(?:\?([^\'\"\\<>#]*))?(?:#(\w+))?/i) || [],
                c = d[1],
                a = d[2],
                b = d[3],
                d = d[4]);
        ...
        function t(c, a) {
            ...
            b.onload = b.onerror = b.onreadystatechange = function() {
                /loaded|complete|undefined/.test(b.readyState) && (b.onload = b.onerror = b.onreadystatechange = null,
        ...
        function y() {
            try {
                var c = navigator
                    ...
                    , a = "";
                b && b.addBehavior && (b.addBehavior("#default#clientCaps"),
                    a = b.connectionType);
                var b = {
                    fl: "",
                    scr: d,
        ...
        function A() {
            ...
            for (a in k) {
                var b = p(k[a].c_id), d;
                "afs" == a ? d = (d = /ssid=([^&]*)/i.exec(l().hash)) && d[1] ? d[1] : "" : (d = l().param,
                    d = d[k[a].id] ? d[k[a].id] : "");
                d ? (c.push("ty=" + k[a].key + ";ck=0;id=" + d),
                    b = new Date,
                    b.setTime(b.getTime() + 2592E6),
                    q(k[a].c_id, d, b.toGMTString())) : b && c.push("ty=" + k[a].key + ";ck=1;id=" + b)
            }
            return {
                pf: c.join("|")
            }
        ...
        function u(c) {
            ...
            if (h.sid && !Ta[h.sid]) {
                for (var a = [], b = 0, d = [w(), x(), {
                    ...
                    for (var f in d[b])
                        d[b].hasOwnProperty(f) && a.push(f + "=" + (d[b][f] || ""));
        ...
        function B(c) {
            ...
            1 * h.pf ? (new RegExp(b)).test(h.hot.url) && e() : (a = h.sid,
                t("http://tcss.qq.com/heatmap/" + a % 100 + "/" + v(a) + ".js?random=" + +new Date, function() {
                    var a;
